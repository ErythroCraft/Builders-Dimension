...
public class BuildersDimensionTeleporter {
	...
	public static void registerPointOfInterest(RegisterEvent event) {
		event.register(Registries.POINT_OF_INTEREST_TYPE, registerHelper -> {
			...
			registerHelper.register(ResourceLocation.parse("builders_dimension:builders_dimension_portal"), poiType);
	...
	public BuildersDimensionTeleporter(ServerLevel level) {
		this.level = level;
	}

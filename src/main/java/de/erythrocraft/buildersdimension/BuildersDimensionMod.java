...
public class BuildersDimensionMod {
	...
	public BuildersDimensionMod() {
		// Start of user code block mod constructor
		// End of user code block mod constructor
		MinecraftForge.EVENT_BUS.register(this);
		IEventBus bus = FMLJavaModLoadingContext.get().getModEventBus();

		BuildersDimensionModBlocks.REGISTRY.register(bus);

		BuildersDimensionModItems.REGISTRY.register(bus);

		BuildersDimensionModTabs.REGISTRY.register(bus);
